"""
MariaDB paper.sid_v_10 데이터를 Milvus m_paper.m_sid_v_10 컬렉션에 적재하는 스크립트
(v1 대비 변경: author_orgname 필드 추가)
...
def create_milvus_collection():
    ...
    fields = [
        ...
        FieldSchema(name="author_orgname", dtype=DataType.VARCHAR, max_length=65535),
        # 신규 필드
    ...
    for batch_start in range(0, total, batch_size):
        ...
        for i in range(batch_start, batch_end):
            ...
            entity = {
                ...
                "author_orgname": str(row["author_orgname"] or ""),
...
def create_indexes(collection):
    ...
    # 스칼라 필드 인덱스
    scalar_index_fields = ["coverdate", "paper_keyword", "title", "volume", "issue", "author", "author_orgname"]
